...
<br>
          ...
          <div class="input-box">
            ...
            <input type="text" placeholder="Enter your phone" name="phone" value="<%=resultSet.getString("phone") %>"  required>
          </div>
          <div class="input-box">
            <span class="details">Nationality</span>
            <input type="text" placeholder="Enter your nationality" name="nationality" value="<%=resultSet.getString("nationality") %>"  required>
          </div>
            <div class="gender-details">
          <input type="radio" name="gender" id="dot-1" value="<%=resultSet.getString("gender") %>"  required>
          <input type="radio" name="gender" id="dot-2" value="gender" value="<%=resultSet.getString("gender") %>" required>
        ...
        <select name="title"  value="<%=resultSet.getString("title") %>" >
        ...
        <select name="department" value="<%=resultSet.getString("department") %>" >
        <option>Bachelor Degree in dental</option>
        <option>Bachelor Degree in medecine</option>
        <option>Bachelor Degree in pharmacy</option>
        </select>
          ...
          <div class="input-box">
            ...
            <input type="text" placeholder="Enter email" name="email"  value="<%=resultSet.getString("email") %>" required>
          </div>
          <div class="input-box">
          ...
          <input type="file" name="picture" value="<%=resultSet.getString("picture") %>"  >
          </div>
